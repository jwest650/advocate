...
export default function CustomPagesIndex() {
  ...
  const [deleteModal, setDeleteModal] = useState<{ isOpen: boolean; page: CustomPage | null }>({ isOpen: false, page: null });
  ...
  const confirmDelete = () => {
    if (deleteModal.page) {
      router.delete(route('landing-page.custom-pages.destroy', deleteModal.page.id), {
        onSuccess: () => {
  ...
  return (
    ...
    >
      ...
      <Dialog open={!!editingPage} onOpenChange={() => setEditingPage(null)}>
        <DialogContent className="max-w-2xl">
          ...
          <form onSubmit={handleSubmit} className="max-h-[80vh] overflow-y-auto space-y-4">
            <div>
              <Label htmlFor="edit_title">{t('Page Title')}</Label>
              <Input
                id="edit_title"
                value={data.title}
            ...
            <div>
              <Label htmlFor="edit_content">{t('Content')}</Label>
              <RichTextEditor
            ...
            <div>
              <Label htmlFor="edit_meta_title">{t('Meta Title (SEO)')}</Label>
              <Input
                id="edit_meta_title"
            ...
            <div>
              <Label htmlFor="edit_meta_description">{t('Meta Description (SEO)')}</Label>
              <Textarea
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end space-x-2">
              ...
              <Button type="submit" disabled={processing}>
                {processing ? t('Creating...') : t('Create Page')}
              </Button>
            </div>
          </form>
        </DialogContent>
      ...
      <CrudDeleteModal
        ...
        itemName={deleteModal.page?.title || ''}
        entityName={t('page')}
      />
    </PageTemplate>
  );
