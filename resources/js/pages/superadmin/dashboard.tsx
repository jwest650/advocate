...
import { RefreshCw, BarChart3, Building2, CreditCard, Users, DollarSign, TrendingUp, Activity } from 'lucide-react';
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="mt-2 text-xl font-bold">{(stats.totalLawFirms || 0).toLocaleString()}</h3>
                </div>
